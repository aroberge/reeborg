...
<ul>
    <li><code>import_lib()</code>: for <b>Javascript</b>, includes the code found in the Library tab
        </li>
...
RUR = window.RUR
RUR.ui.add_help(_usage_, __id, "English", "Instead of my_lib, token, star, triangle, and square, use: ")
