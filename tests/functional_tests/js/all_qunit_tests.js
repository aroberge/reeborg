...
QUnit.test("Centre 1", function(assert) {
    ...
    assert.ok(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_center1.js").success, "Centre1 run successfully.");
    assert.notOk(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_center1_fail.js").success, "Failing program recognized as such.");
    assert.notOk(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_syntax_fail.js").success, "Failing program (syntax error) recognized as such.");
    done();
});
QUnit.test("Centre 1", function(assert) {
    var world_url = "/src/worlds/tutorial_en/center1.json";
    ...
    assert.ok(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_center1_fr.js").success, "Centre1 run successfully.");
    assert.notOk(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_center1_fail_fr.js").success, "Failing program recognized as such.");
    assert.notOk(test_utils.eval_javascript(world_url, "/tests/functional_tests/src/test_syntax_fail_fr.js").success, "Failing program (syntax error) recognized as such.");
    done();
});
QUnit.test("Failed goal with zero frame recorded", function(assert) {
    ...
    test_utils.load_program("/tests/functional_tests/src/test_center1_fail2.js");
...
QUnit.test("Centre 1", function(assert) {
    ...
    var done = assert.async();
    test_utils.set_human_language("en");
    assert.notOk(test_utils.eval_python(world_url, "/tests/functional_tests/src/test_center1_fail.py").success, "Failing program recognized as such.");
    assert.notOk(test_utils.eval_python(world_url, "/tests/functional_tests/src/test_syntax_fail.py").success, "Failing program (syntax error) recognized as such.");
    done();
});
QUnit.test("Centre 1", function(assert) {
    var world_url = "/src/worlds/tutorial_en/center1.json";
    var done = assert.async();
    test_utils.set_human_language("fr");
    assert.notOk(test_utils.eval_python(world_url, "/tests/functional_tests/src/test_center1_fail_fr.py").success, "Failing program recognized as such.");
    assert.notOk(test_utils.eval_python(world_url, "/tests/functional_tests/src/test_syntax_fail_fr.py").success, "Failing program (syntax error) recognized as such.");
    done();
});
...
QUnit.test("Around 1, 2, 3, 4", function(assert) {
    ...
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/around_en.py");
...
QUnit.test("Center 1, 2, 3", function(assert) {
    ...
    test_utils.load_program("/tests/functional_tests/src/center_en.py");
...
QUnit.test("Hurdles 1, 2, 3, 4", function(assert) {
    ...
    test_utils.load_program("/tests/functional_tests/src/hurdle_en.py");
    for (i in world_files) {
        assert.ok(test_utils.eval_python(base_url + world_files[i]).success,
                                      world_files[i] + " run successfully.");
    }
...
QUnit.test("Home 1, 2, 3", function(assert) {
    ...
    test_utils.load_program("/tests/functional_tests/src/home_en.py");
    for (i in world_files) {
        assert.ok(test_utils.eval_python(base_url + world_files[i]).success,
                                      world_files[i] + " run successfully.");
    }
...
QUnit.test("Harvests", function(assert) {
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest1_en.py").success,
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest2_en.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest3.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest3_en.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest4a.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest4_en.py").success,
                                      world_file + " run successfully.");
    // reuse same program
...
QUnit.test("Tokens", function(assert) {
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/tokens1234_en.py").success,
                                      world_file + " run successfully.");
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/tokens56_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Rain", function(assert) {
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/rain_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Newspaper", function(assert) {
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/newspaper_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Storm 1", function(assert) {
    ...
    // random values set.
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm1_en.py");
    last_frame = frames[frames.length-1];
...
QUnit.test("Storm 2; also tests library", function(assert) {
    ...
    test_utils.load_program("/tests/functional_tests/src/storm_library_en.py");
    test_utils.library = test_utils.program;
    world_file = "storm2.json";

    // Need to use run_python instead of eval_python to have initially
    // random values set.
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm2_en.py");
    last_frame = frames[frames.length-1];
...
QUnit.test("Storm 3; also tests library", function(assert) {
    ...
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm3_en.py");
    last_frame = frames[frames.length-1];
...
QUnit.test("Around 1, 2, 3, 4", function(assert) {
    ...
    base_url = "/src/worlds/tutorial_en/";
    world_file = "around1.json";
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/around_fr.py");
    assert.equal(frames.length, 41, "Nb of frames for solution for world " + world_file);
    last_frame = frames[frames.length-1];
    assert.equal(last_frame.world.robots[0].x, 1, "x-position of robot.");
    assert.equal(last_frame.world.robots[0].y, 1, "y-position of robot.");
...
QUnit.test("Centre 1, 2, 3", function(assert) {
    ...
    base_url = "/src/worlds/tutorial_en/";
    world_files = ["center1.json", "center2.json", "center3.json"];
    test_utils.load_program("/tests/functional_tests/src/center_fr.py");
    for (i in world_files) {
        assert.ok(test_utils.eval_python(base_url + world_files[i]).success,
                                      world_files[i] + " run successfully.");
    }
...
QUnit.test("Hurdles 1, 2, 3, 4", function(assert) {
    ...
    base_url = "/src/worlds/tutorial_en/";
    world_files = ["hurdle1.json", "hurdle2.json", "hurdle3.json", "hurdle4.json"];
    test_utils.load_program("/tests/functional_tests/src/hurdle_fr.py");
    for (i in world_files) {
        assert.ok(test_utils.eval_python(base_url + world_files[i]).success,
                                      world_files[i] + " run successfully.");
    }
...
QUnit.test("Home 1, 2, 3", function(assert) {
    ...
    base_url = "/src/worlds/tutorial_en/";
    world_files = ["home1.json", "home2.json", "home3.json"];
    test_utils.load_program("/tests/functional_tests/src/home_fr.py");
    for (i in world_files) {
        assert.ok(test_utils.eval_python(base_url + world_files[i]).success,
                                      world_files[i] + " run successfully.");
    }
...
QUnit.test("Harvests", function(assert) {
    ...
    world_file = "harvest1.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest1_fr.py").success,
                                      world_file + " run successfully.");
    ...
    world_file = "harvest2.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest2_fr.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest3.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest3_fr.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest4a.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/harvest4_fr.py").success,
                                      world_file + " run successfully.");
    // reuse same program
    world_file = "harvest4b.json";
    assert.ok(test_utils.eval_python(base_url + world_file).success,
...
QUnit.test("Tokens", function(assert) {
    ...
    world_file = "tokens1.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/tokens1234_fr.py").success,
                                      world_file + " run successfully.");
    ...
    world_file = "tokens5.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/tokens56_fr.py").success,
                                      world_file + " run successfully.");
    world_file = "tokens6.json";
    assert.ok(test_utils.eval_python(base_url + world_file).success,
                                      world_file + " run successfully.");
...
QUnit.test("Rain", function(assert) {
    ...
    world_file = "rain1.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/rain_fr.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Newspaper", function(assert) {
    ...
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/newspaper0_fr.py").success,
                                      world_file + " run successfully.");


    world_file = "newspaper1.json";
    assert.ok(test_utils.eval_python(base_url + world_file, "/tests/functional_tests/src/newspaper_fr.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Storm 1", function(assert) {
    ...
    // Need to use run_python instead of eval_python to have initially
    // random values set.
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm1_fr.py");
    last_frame = frames[frames.length-1];
    assert.deepEqual(last_frame.world.robots[0].objects, {}, "Testing storm1: no objects carried.");
    RUR.rec.conclude();
    assert.equal(test_utils.feedback_element, "#Reeborg-concludes", "Feedback element ok.");
...
QUnit.test("Storm 2; also tests library", function(assert) {
    ...
    // loading library indirectly
    test_utils.load_program("/tests/functional_tests/src/storm_library_fr.py");
    test_utils.library = test_utils.program;
    ...
    // Need to use run_python instead of eval_python to have initially
    // random values set.
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm2_fr.py");
    last_frame = frames[frames.length-1];
    assert.deepEqual(last_frame.world.robots[0].objects, {}, "Testing storm2: no objects carried.");
    RUR.rec.conclude();
    assert.equal(test_utils.feedback_element, "#Reeborg-concludes", "Feedback element ok.");
...
QUnit.test("Storm 3; also tests library", function(assert) {
    ...
    frames = test_utils.run_python(base_url + world_file, "/tests/functional_tests/src/storm3_fr.py");
    last_frame = frames[frames.length-1];
    assert.deepEqual(last_frame.world.robots[0].objects, {}, "Testing storm3: no objects carried.");
    RUR.rec.conclude();
    assert.equal(test_utils.feedback_element, "#Reeborg-concludes", "Feedback element ok.");
