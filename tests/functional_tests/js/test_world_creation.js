...
QUnit.test( "Empty worlds", function(assert) {
    ...
    assert.deepEqual(RUR.functional_tests.create_empty_world(), test_utils.empty_world, "Empty world explicitly created.");
    assert.ok(RUR.object_identical(RUR.functional_tests.create_empty_world(), test_utils.empty_world),
