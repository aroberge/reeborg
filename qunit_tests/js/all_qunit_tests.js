...
QUnit.test("Centre 1", function(assert) {
    ...
    RUR.unit_tests.set_human_language("en");
    assert.ok(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_center1.js").success, "Centre1 run successfully.");
    assert.notOk(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_center1_fail.js").success, "Failing program recognized as such.");
    assert.notOk(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_syntax_fail.js").success, "Failing program (syntax error) recognized as such.");
});
QUnit.test("Centre 1", function(assert) {
    var world_url = "/src/worlds/tutorial_en/center1.json";
    RUR.unit_tests.set_human_language("fr");
    assert.ok(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_center1_fr.js").success, "Centre1 run successfully.");
    assert.notOk(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_center1_fail_fr.js").success, "Failing program recognized as such.");
    assert.notOk(RUR.unit_tests.eval_javascript(world_url, "/qunit_test/src/test_syntax_fail_fr.js").success, "Failing program (syntax error) recognized as such.");
});
...
QUnit.test("Centre 1", function(assert) {
    var world_url = "/src/worlds/tutorial_en/center1.json";
    RUR.unit_tests.set_human_language("en");
    assert.notOk(RUR.unit_tests.eval_python(world_url, "/qunit_test/src/test_center1_fail.py").success, "Failing program recognized as such.");
    assert.notOk(RUR.unit_tests.eval_python(world_url, "/qunit_test/src/test_syntax_fail.py").success, "Failing program (syntax error) recognized as such.");
});
QUnit.test("Centre 1", function(assert) {
    var world_url = "/src/worlds/tutorial_en/center1.json";
    RUR.unit_tests.set_human_language("fr");
    assert.notOk(RUR.unit_tests.eval_python(world_url, "/qunit_test/src/test_center1_fail_fr.py").success, "Failing program recognized as such.");
    assert.notOk(RUR.unit_tests.eval_python(world_url, "/qunit_test/src/test_syntax_fail_fr.py").success, "Failing program (syntax error) recognized as such.");
});
...
QUnit.test("Harvests", function(assert) {
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest1_en.py").success,
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest2_en.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest3.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest3_en.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest4a.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest4_en.py").success,
                                      world_file + " run successfully.");
    // reuse same program
...
QUnit.test("Tokens", function(assert) {
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/tokens1234_en.py").success,
                                      world_file + " run successfully.");
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/tokens56_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Rain", function(assert) {
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/rain_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Newspaper", function(assert) {
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/newspaper_en.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Harvests", function(assert) {
    ...
    world_file = "harvest1.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest1_fr.py").success,
                                      world_file + " run successfully.");
    ...
    world_file = "harvest2.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest2_fr.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest3.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest3_fr.py").success,
                                      world_file + " run successfully.");

    world_file = "harvest4a.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/harvest4_fr.py").success,
                                      world_file + " run successfully.");
    // reuse same program
    world_file = "harvest4b.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file).success,
...
QUnit.test("Tokens", function(assert) {
    ...
    world_file = "tokens1.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/tokens1234_fr.py").success,
                                      world_file + " run successfully.");
    ...
    world_file = "tokens5.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/tokens56_fr.py").success,
                                      world_file + " run successfully.");
    world_file = "tokens6.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file).success,
                                      world_file + " run successfully.");
...
QUnit.test("Rain", function(assert) {
    ...
    world_file = "rain1.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/rain_fr.py").success,
                                      world_file + " run successfully.");
...
QUnit.test("Newspaper", function(assert) {
    ...
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/newspaper0_fr.py").success,
                                      world_file + " run successfully.");


    world_file = "newspaper1.json";
    assert.ok(RUR.unit_tests.eval_python(base_url + world_file, "/qunit_test/src/newspaper_fr.py").success,
                                      world_file + " run successfully.");
