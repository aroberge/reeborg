...
<ul>
  ...
  <li><code>rien_devant()</code>: "vrai" s'il n'y a pas d'obstacle bloquant la voie de Reeborg.</li>
  <li><code>mur_devant()</code>: "vrai" s'il y a un mur bloquant la voie de Reeborg.</li>
  ...
  <li><code>rien_a_droite()</code>: "vrai" s'il n'y a pas d'obstacle immédiatement à la droite de
      Reeborg.</li>
  <li><code>mur_a_droite()</code>: "vrai" s'il y a un mur immédiatement à la droite de
      Reeborg.</li>
