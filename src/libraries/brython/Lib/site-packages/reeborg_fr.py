...
<ul>
  ...
  <li><code>depose()</code> ou <code>depose("objet")</code> où "objet" est l'un de
    <code>"jeton"</code>,
    <code>"triangle"</code>, <code>"carré"</code>, <code>"étoile"</code>, etc. : Reeborg dépose l'objet
  ...
  <li><code>prend()</code> ou <code>prend("objet")</code> où "objet" est l'un de
     <code>"jeton"</code>, <code>"triangle"</code>, <code>"carré"</code>, <code>"étoile"</code>, etc.</li>
...
class RobotUsage(object):
    ...
    def objet_ici(self, obj=''):
        return RUR.control.object_here(self.body, obj)

    def transporte(self, obj=''):
        return RUR.control.carries_object(self.body, obj)
