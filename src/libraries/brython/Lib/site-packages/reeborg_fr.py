...
<ul>
  ...
  <li><code>face_au_nord()</code>: <code>True</code> si Reeborg fait face au nord
...
style_de_trace = RUR.vis_robot.set_trace_style  # add argument translation
