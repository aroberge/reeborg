...
''' % ("basic-commands-" + __id)
RUR = window.RUR
RUR.ui.add_help(_usage_, __id, "Español", "En lugar de biblio, ficha, estrella, triángulo y cuadrado, uso:")
