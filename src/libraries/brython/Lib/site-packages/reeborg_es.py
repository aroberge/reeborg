...
<li><code>en_orientacion_final()</code>: Estado en que es "true" si Reeborg tiene la
   orientación requerida </li>
...
<li><code>tiene_ficha()</code>: "true" si Reeborg lleva al menos una ficha</li>
...
<li><code>ficha_aqui()</code>: "true" si hay un token en la ubicación del Reeborg</li>
...
<li><code>decir(cadena)</code>:  Aparece un diálogo con Reeborg "diciendo"
    un mensaje escrito en forma de cadena.</li>
