...
<ul>
    <li><code>at_goal()</code>: condition which is <code>True</code> if Reeborg has reached "home"</li>
    ...
    <li><code>right_is_clear()</code>: <code>True</code> if no obstacle is to the immediate right of Reeborg</li>
    <li><code>wall_on_right()</code>: <code>True</code> if a wall is to the immediate right of Reeborg</li>
