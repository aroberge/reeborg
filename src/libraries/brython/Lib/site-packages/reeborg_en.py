...
<ul>
    ...
    <li><code>front_is_clear()</code>: "true" if nothing is blocking Reeborg's way</li>
    <li><code>wall_in_front()</code>: "true" if a wall is blocking Reeborg's way</li>
    ...
    <li><code>right_is_clear()</code>: "true" if no obstacle is to the immediate right of Reeborg</li>
    <li><code>wall_on_right()</code>: "true" if a wall is to the immediate right of Reeborg</li>
