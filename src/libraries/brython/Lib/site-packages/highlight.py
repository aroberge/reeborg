...
def insert_highlight_info(src):
    ...
    for lineno, line in enumerate(lines):
        ...
        if first_word in '''pass def class continue break if from import
            ...
            new_lines.append(line)
        elif (first_word in '''move turn_left pause think take put build_wall f
            ront_is_clear right_is_clear is_facing_north
         at_goal object_here write global nonlocal print repeat narration clear_print'''.split()
             or first_word in '''avance tourne_a_gauche pense prend depose construit_mur
              rien_devant rien_a_droite face_au_nord au_but objet_ici ecrit repete'''.split()):
