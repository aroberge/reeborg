...
def ist_am_ziel():  #py:at_goal
    """
    Zeigt an, ob Reeborg am Zielfeld ist.

    Returns:
        True wenn Reeborg das Ziel erreicht hat, False sonst.
    """
    return RUR._at_goal_()

def baue_wand():  #py:build_wall
    """Instructs Reeborg to build a wall at the location in front of itself."""
    RUR._build_wall_()


def hat_objekt(obj=None):  #py:carries_object
    """
    Zeigt ab, ob Reeborg ein Objekt trägt oder nicht.

    Args:
        obj: optionaler Parameter mit dem Objektnamen als String.

    Returns:
        Wenn kein Argument angegeben wird, ein dict das die Objekte
        (Name und Nummer) enthält;
        Wenn kein Argument angegeben wird, die Anzahl der getragenen Objekte.
...
def loesche_ausgabe():  #py:clear_print
...
def gib_roboter_mit_id(serial_number):  #py:default_robot
    """
...
def ist_vorne_frei():  #py:front_is_clear
    """
...
def ist_norden():  #py:is_facing_north
...
def neues_roboter_bild(images):  #py:new_robot_images
    """
...
def hervorheben_aus():  #py:no_highlight
    """
...
def ist_objekt_hier(obj=None):  #py:object_here
    """
...
def male_zelle(color):  #py:paint_square
...
def drucke_html(html, replace=False):  #py:print_html
    """
...
def setze_aufnahme(boolean):  #py:recording
    """
...
def entferne_roboter():  #py:remove_robots
    """Remove all robots found in the world."""
    RUR._remove_robots_()


def ist_rechts_frei():  #py:right_is_clear
    """
...
def setze_max_anzahl_instruktionen(nb):  #py:set_max_nb_steps
    """
...
def setze_spur_farbe(color):  #py:set_trace_color
    """
...
def setze_spur_stil(style="default"):  #py:set_trace_style
    """
...
def ton_an(boolean):  #py:sound
    """Activate or deactivate sound effects."""
    RUR._sound_(boolean)


def nimm(obj=None):  #py:take
    """
...
def drehe_links():  #py:turn_left
    """Reeborg turns to its left."""
    RUR._turn_left_()


def ist_wand_vorne():  #py:wall_in_front
    """
...
def ist_wand_rechts():  #py:wall_on_right
    """
...
def ErstelleEigenesMenu(content):  #py:MakeCustomMenu
    """
...
def Welt(url, shortname=None):  #py:World
    """
...
class UsedRobot(object):  #py:UR
    ...
    def ist_am_ziel(self):  #py:UR.at_goal
        """
    ...
    def baue_wand(self):  #py:UR.build_wall
        """
    ...
    def traegt_objekt(self, obj=None):  #py:UR.carries_object
        """
    ...
    def gib_farbe(self):  #py:color_here
        '''Returns the value of the color found at Reeborg's location'''
        return RUR._UR.color_here_(self.body)

    def farbe_hier(self):
        '''Returns the value of the color found at Reeborg's location'''
        return self.gib_farbe()


    def ist_vorne_frei(self):  #py:UR.front_is_clear
        """
        Indicates if an obstacle (wall, fence, water, etc.) blocks the path.
