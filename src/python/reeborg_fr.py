...
def install_extra(url):
    """Installe un module (simple fichier) dans un module utile à Reeborg.
       ...
       Voir aussi RUR.extra_python_code(code) qui installe un module
       à partir d'une chaîne de caractères plutôt que d'un fichier externe.

    Args:
        url: le lien à fournir pour trouver le fichier Python.
    """
